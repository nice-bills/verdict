    ...
    <VerdictShell>
      ...
      <section className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-12 text-center -translate-y-[10%]">
        ...
        <div className="w-full max-w-xl space-y-4">
          ...
          >
            <span className="liquid-glass-input pointer-events-none" aria-hidden>
            ...
            <span className="sr-only">Create a new prediction market</span>
          </Link>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          {!FACTORY_ADDRESS && (
            <p className="mb-6 rounded-2xl bg-amber-500/10 px-4 py-3 text-center text-sm text-amber-200">
              Factory address missing: check deployments/shannon.json or set
